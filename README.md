...
很多人已经在 Obsidian 里写 Daily Notes，却依然卡在同一个问题里：
...
| 你现在的状态 | TideLog 给你的改变 |
|---|---|
| Daily Notes 写了很多，但很少回看 | 把计划、任务、情绪和复盘写成可比较的结构 |
...
Many people write Daily Notes, but the notes rarely come back to change what they do next.
