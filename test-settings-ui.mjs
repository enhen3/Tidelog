...
console.log('\nTest 10: settings polish regression guards');
{
    ...
    check(DEFAULT_SETTINGS.activeProvider === 'siliconflow' && DEFAULT_SETTINGS.providers.siliconflow.enabled === true, 'new users start with SiliconFlow selected without a visible default label');
