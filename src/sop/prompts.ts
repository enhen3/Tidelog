 ...
 */
export const MORNING_PROMPT = `<scene>晨间计划</scene>
 ...
 */
export const GOAL_ALIGNMENT_PROMPT = `<scene>晚间复盘 · 目标对标</scene>
 ...
 */
export const SUCCESS_DIARY_PROMPT = `<scene>晚间复盘 · 成功日记</scene>
 ...
 */
export const HAPPINESS_EMOTION_PROMPT = `<scene>晚间复盘 · 开心事与情绪</scene>
 ...
 */
export const ANXIETY_AWARENESS_PROMPT = `<scene>晚间复盘 · 焦虑/不适觉察</scene>
 ...
 */
export const TOMORROW_PLAN_PROMPT = `<scene>晚间复盘 · 明天计划</scene>
 ...
 */
export const DEEP_ANALYSIS_PROMPT = `<scene>晚间复盘 · 深度分析</scene>
 ...
 */
export const REFLECTION_PROMPT = `<scene>晚间复盘 · 反思（斯多葛三问）</scene>
 ...
 */
export const PRINCIPLE_EXTRACT_PROMPT = `<scene>晚间复盘 · 原则提炼</scene>
 ...
 */
export const FREE_WRITING_PROMPT = `<scene>晚间复盘 · 自由随笔</scene>
 ...
 * Profile suggestion
 *
 * 成功标准：每条建议有具体日记证据支撑，有置信度标注。
 */
export const PROFILE_SUGGESTION_PROMPT = `<task>用户画像更新建议</task>

基于近两周日记数据，分析用户画像是否需要更新。
...
1. **情绪特征**：新模式？已知特征变化？
2. **成功模式**：新有效策略？已知模式验证？
3. **思维倾向**：新认知模式？已知倾向改善/强化？
4. **成长边界**：恐慌区→学习区→舒适区的移动？
5. **核心价值观**：新价值观？优先级变化？

每条建议引用至少一条具体日记内容。没有变化的维度注明"暂无变化"。中文回复。
</analysis>`;
